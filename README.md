# 📷 ragephoto-cli - Effortless Photo Export for Gamers

## 🚀 Getting Started

Welcome to ragephoto-cli! This tool allows you to easily export and convert your in-game photos from Grand Theft Auto (GTA) and Red Dead Redemption (RDR) using the powerful libragephoto library.
...
Before using ragephoto-cli, ensure your system meets the following requirements:
...
- **Simple Export:** Easily export photos directly from GTA and RDR.
- **Multiple Formats:** Convert your photos to PNG, JPG, and BMP formats.
- **Batch Processing:** Export multiple photos at once for efficiency.
- **User-Friendly Interface:** Designed for ease of use, even for non-technical users.

## 🖼️ How to Use

After installing ragephoto-cli, follow these steps to export your photos:

1. Launch the ragephoto-cli application.
2. Select the folder containing your in-game photos.
3. Choose your preferred output format (PNG, JPG, BMP).
4. Click the "Export" button.
5. Wait for the application to finish. Your exported photos will be saved in the selected output directory.

## 🔧 Troubleshooting

If you encounter issues while using ragephoto-cli, consider the following tips:
